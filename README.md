# nvim-treesitter-queries-capnp

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-capnp/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-capnp/actions/workflows/validate.yml)

Neovim tree-sitter queries for **capnp**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-capnp",
...
- [ ] Changes are scoped to `capnp` — do not include files for other languages
